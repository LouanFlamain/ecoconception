...
export function CartProvider({ children }: { children: React.ReactNode }) {
  ...
  console.log("CartProvider render - items:", items.length, "total:", total); // Anti-pattern: console.log en prod

  const addToCart = (product: { id: number; name: string; price: number; image: string }) => {
    console.log("Adding to cart:", product.name); // Anti-pattern: console.log
    setItems((prev) => {
  ...
  const removeFromCart = (id: number) => {
    console.log("Removing from cart:", id); // Anti-pattern: console.log
