  ...
  return (
    ...
    <header className="bg-white shadow-md border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
        <Link
          href="/"
          aria-label="EcoShop - Accueil"
          className="text-2xl font-bold text-indigo-600 hover:text-indigo-700 transition-all duration-500 ease-in-out transform hover:scale-105"
        >
          <button>EcoShop</button>
        </Link>
        <nav className="flex items-center gap-8">
          ...
          <Link
            href="/cart"
            aria-label={`Panier (${itemCount} articles) - ${formattedTotal}€`}
